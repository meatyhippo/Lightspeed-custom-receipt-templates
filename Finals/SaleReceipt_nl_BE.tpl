	...
	{% for Sale in Sales %}
		...
		{% if not parameters.page or parameters.page == 2 or not page_loaded %}
			...
			<div>
				...
				{% if Sale.Shop.ReceiptSetup.generalMsg|strlen > 0 %}<p id="receiptNote" class="note" style="padding-top: 50px; margin-top: 0px;">{{ Sale.Shop.ReceiptSetup.generalMsg|noteformat|raw }}</p>{% endif %}
